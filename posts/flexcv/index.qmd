...
You can learn a bit more by checking out the conference poster [here](https://zenodo.org/records/14260131) and by visiting the [project page](https://radlfabs.github.io/flexcv/).
 Feel free to reach out to me if you have any questions or suggestions, preferably using the [issue tracker](https://github.com/radlfabs/flexcv/issues).