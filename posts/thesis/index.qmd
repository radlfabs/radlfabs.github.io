---
title: Uncertainty quantification for cross-validation
date: 2024-10-01
...
Let's have a look at one of the many results tables in my thesis:
{{< include tables/results_table_2nd_full.qmd >}}

The method 'GLMM-UG' seems to do a great job at closing on the nominal coverage. However, the intervals are too wide to be useful. The hierarchical bootstrap methods are the best trade-off between coverage and width. The sample size is crucial for intervals with good coverage *and* width. This is also supported by the following boxplot.
