---
title: "Predicting bicycle traffic using real-time weather data with a REST API"
date: 2024-12-01
...
This post extends the project explained in the post on [modelling bicycle traffic in Cologne](/posts/bicycle/). We will use the models we trained in that post to predict bicycle traffic in real-time using the tomorrow.io weather forecast API. Additionally, we will build a REST API with Flask to serve our models. This will allow us to make predictions with our models in a real-time setting.
